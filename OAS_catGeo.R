OAS_catGeo <- function(DelByGeo_df){
  ...
  CA_EAST <- c('CA -- Quebec', 'CA -- Prince Edward Island', 'CA -- Ontario', 'CA -- Nova Scotia', 'CA -- Newfoundland And Labrador', 'CA -- New Brunswick')
  ...
  US_GreatLakes <- c('US -- Wisconsin', 'US -- Ohio', 'US -- Minnesota', 'US -- Michigan', 'US -- Indiana', 'US -- Illinois')
  US_GulfCoast <- c('US -- Texas', 'US -- Mississippi', 'US -- Louisiana', 'US -- Alabama')
  US_Mid_Atlantic <- c('US -- West Virginia', 'US -- Virginia', 'US -- Pennsylvania', 'US -- New Jersey', 'US -- Maryland', 'US -- Delaware', 'US -- District Of Columbia')
  US_Midwest <- c('US -- Wyoming', 'US -- South Dakota', 'US -- Oklahoma', 'US -- North Dakota', 'US -- Nebraska', 'US -- Montana', 'US -- Missouri', 'US -- Kansas', 'US -- Iowa')
  US_New_England <- c('US -- Vermont', 'US -- Rhode Island', 'US -- New York', 'US -- New Hampshire', 'US -- Massachusetts', 'US -- Maine', 'US -- Connecticut')
  US_NorthWest <- c('US -- Washington', 'US -- Oregon', 'US -- Idaho', 'US -- Alaska')
  ...
  Africa <- c('NG', 'DJ', 'CI', 'GH', 'SN', 'NA', 'TG', 'TN', 'DZ', 'SC', 'MU', 'KE', 'MA', 'BJ', 'MW', 'CD', 'ML', 'GM', 'MZ', 'TZ', 'AO', 'LY', 'GA', 'CM', 'UG', 'RE', 'BW', 'CV', 'TD', 'YT', 'SL', 'SD', 'ZW', 'GW', 'BI', 'GN', 'ZM', 'SZ', 'CG', 'RW', 'MR', 'CF', 'ET', 'SH', 'GQ', 'BF', 'SO', 'LS', 'NE', 'ST', 'ZA','ER','LR')
  Europe <- c('DE', 'GR', 'CZ', 'MC', 'FR', 'IE', 'UA', 'BE', 'LV', 'PL', 'BG', 'NL', 'GI', 'ES', 'ME', 'RS', 'PT', 'HR', 'MT', 'AT', 'RO', 'SK', 'HU', 'CH', 'EE', 'LT', 'LU', 'BA', 'IM', 'BY', 'DK', 'AX', 'GG', 'AL', 'MD', 'LI', 'JE', 'SM', 'MK', 'IS', 'AD', 'VA')
  FarEast <- c('JP', 'SG', 'IN', 'PK', 'CN', 'MY', 'TH', 'HK', 'ID', 'PH', 'VN', 'GE', 'TW', 'AF', 'MO', 'BD', 'KZ', 'AZ', 'MN', 'BN', 'KH', 'BT', 'MM', 'AM', 'IO', 'TM', 'TL', 'KG', 'LA', 'UZ', 'CX', 'TJ')
  ...
  MiddleEast <- c('BH', 'CY', 'EG', 'IR', 'IQ', 'IL', 'JO', 'KW', 'LB', 'OM', 'QA', 'SA', 'SY', 'TR', 'AE', 'YE')
  SouthAmerica <- c('EC', 'AR', 'VE', 'BR', 'CO', 'PE', 'UY', 'BO', 'CL', 'PY', 'SR', 'GY', 'GF', 'FK')
