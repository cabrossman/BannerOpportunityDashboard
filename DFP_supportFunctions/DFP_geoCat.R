DFP_geoCat <- function(geo_data,geoInformation = NULL){
  ...
  US_Mid_Atlantic <- c('US -- West Virginia', 'US -- Virginia', 'US -- Pennsylvania', 'US -- New Jersey', 'US -- Maryland', 'US -- Delaware', 'US -- District Of Columbia','US -- District of Columbia')
  ...
  geo_data$Area <- ifelse(geo_data$Geo %in% CA_EAST,"CA_EAST",
                             ifelse(geo_data$Geo %in% CA_WEST, "CA_WEST",
                                    ifelse(geo_data$Geo %in% US_Flordia, "US_Florida",
                                           ifelse(geo_data$Geo %in% US_GreatLakes,"US_GreatLakes",
